...
// Modify ListFeatures.java so that it uses String instead of Pets, and explain any difference in results.
...
public class T_06 {
    public static void main(String[] args) {
        ...
        Collections.addAll(ls, "Fishing", "can", "be", "a", "hobby", "or a", "job");
        ...
        if (ls.size() < 4) {
            List<String> s =
                    Arrays.asList("London", "Madrid", "Moscow", "Oslo");
            ls.addAll(0, s);
        }
